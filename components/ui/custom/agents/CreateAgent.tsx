...
const quickSuggestions = [
  {
    label: "Find AI Jobs",
    prompt:
      "Find the latest AI and software developer jobs posted this week and summarize the best matches",
  },
  {
    label: "Inbox Summary",
    prompt:
      "Check my inbox and summarize the most important emails that need my attention",
  },
  {
    label: "Research Topic",
    prompt:
      "Research a topic across the web and give me a concise summary with key findings and sources",
  },
  {
    label: "Plan My Day",
    prompt:
      "Check my calendar and tasks, then create a prioritized plan for my day",
  },
  {
    label: "Reddit Trends",
    prompt:
      "Find trending Reddit discussions about AI tools and summarize the most useful insights",
  },
  {
    label: "Daily News",
    prompt:
      "Find the most important technology and AI news from today and summarize it",
  },
];
...
const templates = [
  {
    ...
    description:
      "Search the web for the latest jobs matching my skills and experience",
  ...
  },
  {
    ...
    description:
      "Summarize important emails and highlight what needs my attention",
    icon: Mail,
    iconBg: "bg-blue-100",
  ...
  },
  {
    ...
    description:
      "Search the web and create a useful research summary with sources",
    icon: Globe,
    ...
    <div className="mt-5">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Ask what type of agent you want to create. Type your goal, task, or
          workflow
        </p>
      </div>
      ...
      <div className="w-full border rounded-2xl bg-background p-3 mt-3 shadow-lg shadow-purple-100 hover:shadow-purple-200">
        ...
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            onClick={OnSubmit}
            size={"icon"}
            className="h-9 w-9 rounded-full bg-purple-400"
          >
      ...
      {loading ? (
        <div className="flex gap-2 items-center p-5 mt-7 border rounded-xl shadow-lg">
